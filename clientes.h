...
typedef struct { // Definindo uma estrutura para armazenar as informações dentro de cada contato
    char nome[100]; // Declarando variável do tipo string com 20 caracteres para armazenar o nome do contato
    long int cpf; // Declarando variável do tipo inteiro longo para armazenar a senha do contato
    char conta[5]; // Declarando variável do tipo string com 100 caracteres para armazenar o email do contato
    long int telefone; // Declarando variável do tipo inteiro longo para armazenar o telefone do contato
    long int senha; // Declarando variável do tipo inteiro longo para armazenar a senha do contato
...
ERRO transferir(Banco clientes[], int *pos); // Assinatura da função de adicionar contato
